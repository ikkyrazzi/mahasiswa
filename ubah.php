  ...
  <div id="wrapper">
    ...
    <div class="row">
        ...
        <div class="card shadow mb-4 py-4 px-4 col-12">
            ...
            <form method="post" action="ubah.php?id=<?=$user['id']?>">
                <div class="form-group">
                    <label for="id">ID</label>
                    <input type="text" class="form-control" id="id" name="id" value="<?= $user['id']; ?>" maxlength="16" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="jk" name="jk" type="text">
                ...
                <div class="form-group float-right">
                    ...
                    <a class="btn btn-outline-secondary ml-2" role="button" href="profile.php">Batal</a>
                </div>
            </form>
            <!-- akhir form input -->
